<template>
  <div class="bill">
    ...
    <input class="bg-gray-100 pt-1 px-2 rounded-t hover:bg-gray-300 active:bg-white focus:bg-white border-b border-indigo-900 w-32 outline-none" v-model="energyPrice" type="text" placeholder="Precio" required />
